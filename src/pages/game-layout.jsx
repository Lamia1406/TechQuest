...
export default function GameLayout({ games, currentScore, setCurrentScore }) {
    ...
    useEffect(() => {
        // If all components are highlighted, move to the next game
        if (highlighted.length === shuffledComponents.length) {
    ...
    }, [highlighted, shuffledComponents.length, currentGameIndex, games.length]);
