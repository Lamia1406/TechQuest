...
const ProgressBar = ({ progress }) => {
  const getSvgPath = (level, currentLevel) => {
    const strokeColor = level <= currentLevel ? "#37454E" : "#37454E60";  // Gray if not reached, solid color if reached
